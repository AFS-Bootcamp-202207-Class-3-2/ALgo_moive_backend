...
public interface OrderRepository extends JpaRepository<Order,String> {
    ...
    @Query(nativeQuery = true,
            value = "select id,price,status,session_id,movie_id,cinema_id,room_id,user_id,seat_info,create_time from t_order where user_id=?1 order by create_time desc limit ?3 offset ?2")
